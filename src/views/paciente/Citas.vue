...
import { usePacienteCitasStore } from '@/stores/paciente/citas'
import AgendarCita from '@/components/paciente/AgendarCita.vue'
import CancelarCita from '@/components/paciente/CancelarCita.vue'
import ReagendarCita from '@/components/paciente/ReagendarCita.vue'
import DetalleCita from '@/components/paciente/DetalleCita.vue'
